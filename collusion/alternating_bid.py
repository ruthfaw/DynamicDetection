class AlternatingBid:
# create collusion graph
    ...
    def calculate_collusion_score(self, avg_alpha_rating, avg_gamma_rating, avg_delta_rating, avg_epsilon_rating, avg_zeta_rating, avg_binding_factor, collusion_rating):
        ...
        collusion_score = (((avg_alpha_rating * alpha_weight) + (avg_gamma_rating * gamma_weight) + (avg_delta_rating * delta_weight) + (avg_epsilon_rating * epsilon_weight) + (avg_zeta_rating * zeta_weight) + (collusion_rating * collusion_rating_weight) + (avg_binding_factor * binding_factor_weight)) / (alpha_weight + gamma_weight + delta_weight + epsilon_weight + zeta_weight + collusion_rating_weight + binding_factor_weight)) * 10
